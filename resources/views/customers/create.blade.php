...
<div class="max-w-4xl mx-auto font-sans text-gray-800">
    <div class="bg-white shadow-md rounded-xl border border-gray-200">
        ...
        <div class="p-6 space-y-8" x-data="smartAddress()" x-init="init()">
            ...
            <form method="POST" action="{{ route('customers.store') }}" class="space-y-8" id="customerForm"
                ...
                <section class="bg-gray-50 p-4 rounded-lg border border-gray-200">
                    <h2 class="text-lg font-medium text-gray-700 mb-3">Login Credentials</h2>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                        <div>
...
<div class="absolute inset-0 bg-gray-600/20 backdrop-blur-md transition-opacity"></div>
                ...
                <!-- Modal Container -->
                <div class="relative bg-white rounded-2xl shadow-2xl max-w-4xl w-full max-h-[85vh] overflow-hidden transform transition-all"
                     x-transition:enter="ease-out duration-300"
                    ...
                    <!-- Modal Body -->
                    <div class="p-6 space-y-6 max-h-[55vh] overflow-y-auto">
                        <!-- Location Badges -->
...
function smartAddress() {
    return {
        ...
        initMainMap() {
            ...
            this.map = L.map('map').setView([7.3081, 125.6842], 13);
        ...
        initModalMap() {
            ...
            this.modalMap = L.map('modalMap').setView([7.3081, 125.6842], 12);
            L.tileLayer('https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png', {
                attribution: '© OpenStreetMap contributors'
            }).addTo(this.modalMap);

            this.modalMarker = L.marker([7.3081, 125.6842], { 
                draggable: true 
            }).addTo(this.modalMap);
