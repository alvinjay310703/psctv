                        ...
                        <ol class="inline-flex items-center space-x-1 md:space-x-3">
                            ...
                            <li>
                                <div class="flex items-center">
                                    ...
                                    <span class="ml-1 text-sm font-medium text-gray-500 md:ml-2">Announcements</span>
                                </div>
                            </li>
                        </ol>
                    </nav>
                    <h1 class="text-3xl font-bold text-gray-900">Announcements</h1>
                    <p class="text-gray-600 mt-1">Manage and create announcements for customers and technicians</p>
                </div>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden hover:shadow-md transition-shadow">
                    <div class="p-6">
                        ...
                        <div class="flex items-start justify-between mb-4">
                            <div class="flex-1">
                                <h3 class="text-lg font-semibold text-gray-900 mb-1 line-clamp-2">{{ $announcement->title }}</h3>
                        ...
                        <div class="flex items-center justify-between pt-4 border-t border-gray-100">
                            <div class="flex items-center space-x-2">
                                ...
                                <span class="text-xs text-gray-500">By {{ $announcement->creator->name ?? 'Unknown' }}</span>
                            </div>
                            <div class="flex items-center space-x-2">
