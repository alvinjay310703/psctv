        ...
        <div class="bg-white/80 backdrop-blur-sm p-8 rounded-3xl shadow-xl border border-white/20">
            <div class="flex flex-col lg:flex-row items-start lg:items-center gap-8">
                ...
                <div class="flex-shrink-0">
                    <div class="relative">
                        <img src="https://ui-avatars.com/api/?name={{ urlencode(Auth::user()->name) }}&background=6366f1&color=fff&size=120"
                ...
                <div class="flex-1 min-w-0">
                    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                        <div>
                            ...
                            <p class="text-lg text-gray-600 mb-3">{{ Auth::user()->email }}</p>
                ...
                <div class="bg-gradient-to-r from-slate-50 to-gray-50 p-6 rounded-2xl border border-gray-200/50">
                    <div class="flex items-center space-x-3">
                        ...
                        <div>
                            ...
                            <p class="text-lg font-semibold text-gray-900">{{ Auth::user()->updated_at->format('M d, Y') }}</p>
                        </div>
                    </div>
                </div>
